...
pub const Option = enum(c_int) {
    ...
    // bora fork (patch 0003): kept out of numeric order, away from the
    // enum tail upstream appends to, so upstream option additions and
    // their vendor patches never share a hunk with it.
    reflow_on_resize = 42,
    terminfo_name = 37,
    clipboard_read = 38,
