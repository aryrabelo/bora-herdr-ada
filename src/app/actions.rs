...
mod tests {
    ...
    fn background_waiting_sets_attention_toast() {
        ...
        assert_eq!(
            toast.context,
            format!("background · 2 · {}:p1", state.workspaces[1].id)
        );
    }
    ...
    fn background_toast_includes_tab_name_when_workspace_has_multiple_tabs() {
        ...
        assert_eq!(
            toast.context,
            format!("background · 2 · logs · {}:p2", state.workspaces[1].id)
        );
    }
    ...
    fn background_tab_in_active_workspace_still_sets_toast() {
        ...
        assert_eq!(
            toast.context,
            format!("active · 1 · logs · {}:p2", state.workspaces[0].id)
        );
    }
    ...
    #[test]
    fn close_pane_last_pane_in_parent_worktree_group_closes_only_that_workspace() {
