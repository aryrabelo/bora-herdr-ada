...
// Fork note: bora's protocol lineage reached 18 independently of upstream's
// 19 after this merge diverged. The merged source must exceed both released
// versions (18 and 19) so stale clients on either lineage are rejected
// cleanly.
