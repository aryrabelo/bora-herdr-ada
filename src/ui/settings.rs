    ...
    match app.settings.section {
        ...
        SettingsSection::Sidebar => {
            render_modal_choice_list(
                ...
                content_area,
                "sidebar view",
                "flat: freely drag-reorderable, no grouping. folders: flat list with only your visual-group folders (no repo/branch, no pane badge). repo: grouped under repo headers",
                &[
                    ("flat", ViewMode::Flat),
