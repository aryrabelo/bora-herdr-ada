...
pub fn config_diagnostic_summary(diagnostics: &[String]) -> Option<String> {
    ...
    Some(format!("{target}{impact}; bora config check"))
}
...
mod tests {
    ...
    fn config_diagnostic_summary_uses_compact_actionable_banner() {
        ...
        assert_eq!(
            ...
            Some("config.toml; bora config check")
        );
    }
    ...
    fn config_diagnostic_summary_reports_unknown_keys_compactly() {
        ...
        assert_eq!(
            config_diagnostic_summary(&diagnostics).as_deref(),
            Some("config.toml has unknown keys; bora config check")
        );
    }
    ...
    fn config_diagnostic_summary_reports_default_fallback() {
        ...
        assert_eq!(
            config_diagnostic_summary(&diagnostics).as_deref(),
            Some("config.toml invalid; using defaults; bora config check")
        );
    }
    ...
    fn config_diagnostic_summary_reports_unreadable_config_impact() {
        ...
        assert_eq!(
            ...
            Some("config.toml unreadable; using defaults; bora config check")
        );
        ...
        assert_eq!(
            ...
            Some("config.toml unreadable; keeping current config; bora config check")
        );
    }
    ...
    fn config_diagnostic_summary_reports_retained_live_config() {
        ...
        assert_eq!(
            config_diagnostic_summary(&diagnostics).as_deref(),
            Some("config.toml invalid; keeping current config; bora config check")
        );
    }
