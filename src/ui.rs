...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        normalized_workspace_scroll, sidebar_section_divider_rect, view_mode_toggle_rect,
        ...
        ProjectSection, WorkspaceListEntry,
    },
};
...
pub fn render_with_runtime_registry(
    ...
    match app.mode {
        ...
        Mode::RenameWorkspace | Mode::RenameTab | Mode::RenamePane | Mode::SetWorkspaceGroup => {
