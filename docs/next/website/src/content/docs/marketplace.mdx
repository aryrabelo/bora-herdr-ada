---
title: Marketplace
description: Discover community Bora plugins on GitHub, and get your own plugin listed.
---

The Bora plugin marketplace indexes community plugins. Browse it at
...
itself, not that Bora vetted it, so the
