...
template: splash
hero:
  tagline: "Install, learn, and configure Bora. Start on the path that matches you — no multiplexer experience required."
  image:
...
<CardGrid>
  <Card title="New to terminal multiplexers?">
    You don't need to learn shortcuts to start. Bora is mouse-first: click panes, drag borders, split and switch from right-click menus.
...
```text
Help me understand and set up Bora. Read https://herdr.dev/agent-guide.md first, then walk me through it step by step.
```

The guide covers Bora's concepts, setup, configuration, and common fixes, so your agent can answer from the docs instead of improvising.
...
<CardGrid>
  ...
  <Card title="Configuration">
    ...
    [Configure Bora →](/docs/configuration/)
  </Card>
  <Card title="API">
    Control Bora from scripts, tools, and agents through the CLI and local socket API.
